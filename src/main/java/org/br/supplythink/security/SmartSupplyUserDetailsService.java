package org.br.supplythink.security;

import static org.br.supplythink.utils.JdbcUtils.PERMISSOES_POR_GRUPO;
import static org.br.supplythink.utils.JdbcUtils.PERMISSOES_POR_USUARIO;
import static org.br.supplythink.utils.JdbcUtils.USUARIO_POR_LOGIN;
...
@Component
public class SmartSupplyUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		...
		try {
			...
			SmartSupplyUserDetails userDetails = buscarUsuario(connection, login);
	...
	public SmartSupplyUserDetails buscarUsuario(Connection connection, String login) throws SQLException {
		...
		return new SmartSupplyUserDetails(nome, login, password, ativo);
	}
